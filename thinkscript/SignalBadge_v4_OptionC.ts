# ============================================================
# THINKSCRIPT SIGNAL BADGE v4.3-C (Option C: VWAP Directional)
...
#
# SCORING:
#   +6 to +10  -> STRONG BUY  -- CALL  (Green)
#   +3 to +5   -> WEAK BUY   -- CALL  (Light Green)
#   -2 to +2   -> NO TRADE           (Gray)
#   -3 to -5   -> WEAK SELL  -- PUT   (Light Red)
#   -6 to -10  -> STRONG SELL -- PUT  (Red)
#
# TIER WEIGHTS:
...
# ---- Signal Thresholds ----
input strongThreshold = 6;
input weakThreshold = 3;
...
# VWAP directional: bullish only if above AND moving away from VWAP
# Neutral if above but falling toward VWAP (momentum fading)
...
# When above but falling toward VWAP, or below but rising toward VWAP = neutral (0 vote)
